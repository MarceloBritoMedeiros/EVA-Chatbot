...
class QueriesSender{  
  ...
  _selecaoUnidades(recipientID, textId){
  ...
  _selecaoDias(recipientID, textId, userInput){
    var cont=1;
  ...
  _selecaoHorarios(recipientID, textId, userInput){
    var cont=1;        
  ...
  _transicao(recipientID, textId, userInput){
    var cont=1;
  ...
  sendList(recipientID, textId, i, userInput){
    switch(i["type"]){
      case "selecao_unidades":
        this._selecaoUnidades(recipientID, textId)
        break;
      case "selecao_dias":            
        this._selecaoDias(recipientID, textId, userInput);
        break;
      case "selecao_horarios":            
        this._selecaoHorarios(recipientID, textId, userInput);
        break;
      case "transicao":        
        this._transicao(recipientID, textId, userInput);
        break;
      case "cancelamento":
        this._cancelamento();
        break;
